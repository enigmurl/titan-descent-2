...
public class TutorialButton extends Button {
    ...
    public TutorialButton(Context context,int pointer, float x, float y, float w, float h,boolean disabled) {
    ...
    protected void onHardRelease(MotionEvent e) {
        ...
        synchronized (TitanRenderer.LOCK) {
            ...
            guiData.stackScene(World.class, InGameOverlay.class, TutorialLayout.class);
        }
